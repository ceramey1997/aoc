...
def part_one():
    ...
    final = DoingIt("aoc/day9/input1.txt")
    return final.total
...
def part_two():
    class DoingIt:
        ...
        def __init__(self, fileName: str):
            ...
            self.total: int = sum([e[0][0] for e in self.extrapolated_data])
        ...
        def extrapolate(self, full_hist: list[list[int]]) -> list[list[int]]:
            ...
            for idx, his in enumerate(full_hist):
                ...
                if idx == 0:
                    his.insert(0, 0)
                    continue
                amount_to_increase = his[0]
                adding_to = full_hist[idx+1][0]
                extrapolated_data_point = adding_to - amount_to_increase
                full_hist[idx+1].insert(0,extrapolated_data_point)
            full_hist.reverse()
            return full_hist
    ...
    final = DoingIt("aoc/day9/input2.txt")
    return final.total
